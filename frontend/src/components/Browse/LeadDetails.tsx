...
const LeadDetailComp = () => {
  ...
  const handleReportLead = async () => {
    try {
      setSubmitting(true);

      const response = await Api.reportLead(leadId, reason);

      if (response.status === 200 || response.status === 201) {
        toast.success("Lead reported successfully", {
          duration: 4000,
          description:
      ...
      toast.error(
        (err as any).response.data.message ||
          "An error occurred while reporting the lead",
        {
          duration: 4000,
          position: "top-center",
          action: {
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-red-50 to-amber-50 rounded-xl border border-red-200 p-6">
              <h3 className="font-semibold text-slate-900 mb-3">
                Looks like a scam/spam?
              </h3>
              <p className="text-sm text-slate-600 mb-4">
                Kindly report this lead to help us maintain a safe community.
              </p>
              <div className="flex gap-3">
                <Dialog
                ...
                >
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Please provide a reason for reporting this Lead. Our
                    ...
                    <DialogFooter>
                      ...
                      >
                        {submitting ? "Reporting..." : "Report Lead"}
                      </Button>
                    </DialogFooter>
                  </DialogContent>
                </Dialog>
