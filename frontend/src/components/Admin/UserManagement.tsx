  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <Button onClick={() => fetchUsers(pagination.currentPage)} className="flex items-center gap-2">
      ...
      <Card className="p-6">
        <div className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            <Button onClick={handleSearch} className="flex items-center gap-2 w-full md:w-auto">
              <Search className="h-4 w-4" />
              Search
            </Button>
            <Button className='w-full md:w-auto' onClick={handleClearFilters} variant="outline">
              Clear Filters
            </Button>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600">{totalCounts.total}</div>
